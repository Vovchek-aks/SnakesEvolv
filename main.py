...
class Snake:
    ...
    def go(self, dir_):
        ...
        pos = pos[0] + dirs_dirs[dir_][0], pos[1] + dirs_dirs[dir_][1]
...
for y in range(5):
    ...
    Cell.add_cell(Cell((10, y + 10), CellType.eat))
...
Snake([Cell((10, y), CellType.snake) for y in range(40, 44)])
...
while True:
    ...
    if Snake.snakes:
        Snake.snakes[0].go(Dirs.up if Snake.snakes[0].cells[0].pos[1] >= 2 else Dirs.right)
